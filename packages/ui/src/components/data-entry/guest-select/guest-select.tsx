    ...
    <div className="space-y-4 border-b border-gray-200 pb-4">
      ...
      <div className="space-y-4">
        <GuestCounter
          option={room.adults}
          onValueChange={value =>
            onUpdateRoom(room.id, { adults: { ...room.adults, value } })
          }
          minValue={1}
        />
        <GuestCounter
          ...
          onValueChange={value =>
            onUpdateRoom(room.id, { children: { ...room.children, value } })
          }
          minValue={0}
        />
      </div>
...
export function GuestSelect({ onSave, className }: GuestSelectProps) {
  const { rooms, addRoom, removeRoom, updateRoom } = useGuest();
