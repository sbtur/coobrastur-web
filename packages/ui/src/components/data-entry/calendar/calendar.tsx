...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          'bg-white flex flex-col rounded-md p-3 shadow-xl sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0',
        month: 'space-y-4',
        ...
        day: cn(
          ...
          'h-8 w-8 p-0 font-normal text-sm text-neutral-500 cursor-pointer hover:text-neutral-500 hover:bg-gray-200/30',
        ),
        day_range_start:
        ...
        day_today:
          'bg-gray-200/30 text-neutral-500 aria-selected:text-neutral-500',
        day_outside:
          'day-outside text-neutral-300 opacity-50 aria-selected:bg-gray-200/30 aria-selected:text-neutral-300',
        day_disabled: 'text-neutral-300 opacity-50 cursor-default',
        day_range_middle:
          'text-neutral-500 bg-secondary-200 hover:bg-secondary-200 hover:text-neutral-500 aria-selected:text-neutral-500 rounded-none ',
